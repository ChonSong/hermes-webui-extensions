...
## Corpus Check
- 79 files · ~271,785 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 725 nodes · 1337 edges · 58 communities (39 shown, 19 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 62 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cb7ed3c3`
...
## Knowledge Gaps
- **244 isolated node(s):** `extensions`, `extensions`, `extensions`, `extensions`, `extensions` (+239 more)
