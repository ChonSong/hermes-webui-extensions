  ...
  function animate() {
    ...
    if (_vrm) {
      ...
      try {
        ...
        // Rotate around Z to bring arms down from T-pose (~23°)
        if (a) a.rotation.z = 0.4 + Math.sin(performance.now() / 1000 * 1.5) * 0.04;
        if (b) b.rotation.z = -0.4 - Math.sin(performance.now() / 1000 * 1.5) * 0.04;
      } catch(e) {}
    }
